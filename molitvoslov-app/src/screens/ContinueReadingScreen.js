...
export const ContinueReadingScreen = ({
  navigation,
}) => {
  ...
  const makeItem = progressItem => {
    ...
    if (
      progressItem.source_type ===
      'psalter'
    ) {
      const info =
        progressItem.anchor_info;
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.subtitle}>
            Все начатые тексты и сохранённый прогресс
          </Text>
        </View>

        <Text style={styles.headerCross}>
          ☦
        </Text>
      </View>
